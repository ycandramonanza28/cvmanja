        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center gap-2 mb-4">
              <div className="w-9 h-9 rounded-xl bg-brand-teal flex items-center justify-center">
                <span className="text-white font-display font-bold text-lg">M</span>
              </div>
              <div>
                <div className="font-display font-semibold text-white text-[15px] leading-none">Jasa CV</div>
                <div className="font-display font-bold text-brand-teal text-[15px] leading-none">MANJA</div>
              </div>
            </div>
            ...
            <div className="flex gap-3">
              ...
              <a href="https://wa.me/6281234567890" target="_blank" rel="noopener" className="w-9 h-9 rounded-xl bg-white/10 hover:bg-brand-teal flex items-center justify-center transition-colors">
          ...
          <div>
            ...
            <div className="space-y-2.5">
              {["CV ATS", "CV Kreatif", "CV Custom", "Review CV", "Konsultasi"].map((l) => (
